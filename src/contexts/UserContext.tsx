...
interface UserContextType {
  ...
  updateUser: (updates: { name?: string; bio?: string; image?: string; birthdate?: string; hasCompletedOnboarding?: boolean }) => Promise<void>;
...
export const UserProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const updateUser = async (updates: { name?: string; bio?: string; image?: string; birthdate?: string; hasCompletedOnboarding?: boolean }) => {
    if (!user) {
